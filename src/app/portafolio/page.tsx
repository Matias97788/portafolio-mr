      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-14">
        ...
        <div className="mt-14 space-y-16">
          {PORTFOLIO_CATEGORIES.map((cat) => {
            ...
            return (
              <AnimatedSection key={cat.id} className="scroll-mt-28">
                <section id={cat.id}>
        ...
        <AnimatedBlock className="mt-16" delay={80}>
          <section className="rounded-[var(--radius-lg)] border border-border bg-card/40 p-6">
            <h2 className="text-xl font-semibold">
              ¿Quieres un proyecto similar?
            </h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Cuéntame el objetivo y te propongo alcance, tiempos y costo
              estimado.
            </p>
            <Link
              href="/contacto"
