  ...
  return (
    <article className="blog-content space-y-4 text-base leading-7 text-foreground/90">
      <ReactMarkdown
        ...
        components={{
          h2: ({ children }) => (
            <h2 className="font-display mt-10 scroll-mt-24 text-3xl tracking-tight text-foreground">
              {children}
            </h2>
          ),
          h3: ({ children }) => (
            <h3 className="font-display mt-8 scroll-mt-24 text-2xl tracking-tight text-foreground">
              {children}
            </h3>
          ),
